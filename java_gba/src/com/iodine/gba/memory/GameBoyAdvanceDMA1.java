...
public class GameBoyAdvanceDMA1 {
    ...
    public GameBoyAdvanceDMA1(GameBoyAdvanceIO ioCore) {
        this.IOCore = ioCore;
    }
    ...
    public int nextEventTime() {
        ...
        switch (this.enabled) {
            ...
            case 0x4:
                ...
                break;
            case 0x8:
                clocks = this.sound.nextFIFOAEventTime();
                break;
        }
        return clocks;
    }
